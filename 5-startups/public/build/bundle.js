...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProfileList = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StartupList = function (_Component) {
		...
		function StartupList(props, context) {
			...
			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(StartupList).call(this, props, context));
	
			_this2.updateStartup = _this2.updateStartup.bind(_this2);
			_this2.createStartup = _this2.createStartup.bind(_this2);
			_this2.state = {
				startup: {
					name: '',
					founder: '',
		...
		_createClass(StartupList, [{
			...
			key: 'createStartup',
			value: function createStartup() {
				var _this = this;
				_api2.default.handlePost('/api/startup', this.state.startup, function (err, response) {
					if (err) {
						alert(err.message);
						return;
					}
			...
			value: function componentDidMount() {
				...
				_api2.default.handleGet('/api/startup', {}, function (err, response) {
					if (err) {
						alert(err.message);
						return;
					}
	
					_store2.default.dispatch(_actions2.default.startupsReceived(response.results));
				});
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', { value: this.state.startup.name, onChange: this.updateStartup, type: 'text', id: 'name', placeholder: 'Name' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { value: this.state.startup.founder, onChange: this.updateStartup, type: 'text', id: 'founder', placeholder: 'Founder' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { value: this.state.startup.url, onChange: this.updateStartup, type: 'text', id: 'url', placeholder: 'URL' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'button',
						{ onClick: this.createStartup },
						'Add'
					)
				);
			}
	...
	exports.default = (0, _reactRedux.connect)(stateToProps)(StartupList);
		...
		_createClass(ListItem, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'span',
						{ onClick: this.handleClick, style: { color: textColor } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		startupCreated: function startupCreated(startup) {
			return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _startupReducer = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Featured = __webpack_require__(209);
	...
	var ProfileList = function (_Component) {
		...
		function ProfileList(props, context) {
			...
			_this2.state = {
				...
				profiles: [{ id: 0, name: 'travis kalanick', location: 'california', description: 'founder of Uber' }, { id: 1, name: 'steve jobs', location: 'california', description: 'founder of apple' }, { id: 2, name: 'dennis crowley', location: 'new york', description: 'founder of foursquare' }]
			};
			return _this2;
		}
		...
		_createClass(ProfileList, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { id: 'location', onChange: this.updateProfile, type: 'text', placeholder: 'Location' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'a',
					...
					_react2.default.createElement(_Featured2.default, { entity: this.state.selectedProfile })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Featured = function (_Component) {
		...
		function Featured(props, context) {
			_classCallCheck(this, Featured);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Featured).call(this, props, context));
		}
