...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Communities = __webpack_require__(169);
	...
	var _Community = __webpack_require__(212);
	...
	var Main = function (_Component) {
		...
		_createClass(Main, [{
			...
			value: function render() {
				...
				if (page == 'community') content = _react2.default.createElement(_Community2.default, { slug: this.props.slug });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Communities = function (_Component) {
		...
		function Communities(props, context) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Communities).call(this, props, context));
	
			_this.updateNewCommunity = _this.updateNewCommunity.bind(_this);
			_this.addCommunity = _this.addCommunity.bind(_this);
			_this.state = {
				newCommunity: {
					name: '',
					city: '',
	...
	exports.default = (0, _reactRedux.connect)(stateToProps)(Communities);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _communityReducer = __webpack_require__(192);
	
	var _communityReducer2 = _interopRequireDefault(_communityReducer);
	
	var _accountReducer = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		communitiesReceived: function communitiesReceived(communities) {
			return {
				type: _constants2.default.COMMUNITIES_RECEIVED,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommunityPreview = function (_Component) {
	    ...
	    function CommunityPreview() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(CommunityPreview).apply(this, arguments));
	    }
	...
	var Register = function (_Component) {
		...
		_createClass(Register, [{
			...
			value: function register(event) {
				event.preventDefault();
				_api2.default.handlePost('/api/profile', this.state.user, function (err, response) {
					if (err) {
						alert(err.message);
						return;
					}
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', { type: 'text', onChange: this.updateUser, id: 'firstName', placeholder: 'First Name' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { type: 'text', onChange: this.updateUser, id: 'lastName', placeholder: 'Last Name' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { type: 'text', onChange: this.updateUser, id: 'email', placeholder: 'Email' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { type: 'password', onChange: this.updateUser, id: 'password', placeholder: 'Password' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'button',
					...
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { type: 'password', onChange: this.updateCredentials, id: 'password', placeholder: 'Password' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'button',
						{ onClick: this.login },
